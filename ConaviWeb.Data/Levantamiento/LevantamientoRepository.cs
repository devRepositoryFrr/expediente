        ...
        public async Task<IEnumerable<Predio>> GetFullPrediosAdquisicion()
        {
            ...
            var sql = @"
                        SELECT `formato_predio`.`id` Id,
                            ...
                            date_format(`formato_predio`.`fecha_recorrido`, '%Y/%m/%d') FechaRecorrido,
